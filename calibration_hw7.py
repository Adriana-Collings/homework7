...
class Calibration:
    ...
    def sample_posterior(self):
        ...
        for cohort_id in self._cohortIDs:
            ...
            survivaltimeslist = multiCohort._survivalTimes[cohort_id]
            fiveyearsurvival = sum(j > 5 for j in survivaltimeslist)/1000
            ...
            weight = stat.binom.pmf(k=OBS_SUCCESS,n=OBS_N,p=fiveyearsurvival)
...
import SurvivalModelClasses as SMC
...
cohort =SMC.Cohort(id=1, mortality_prob=MORTALITY_PROB, pop_size=SIM_POP_SIZE)

cohortOutcome=cohort.simulate(n_time_steps=TIME_STEPS)

survivaltimes = cohortOutcome.get_survival_times()
print("Problem 1: Five year survival:", ((sum(i > 5 for i in survivaltimes))/573)*100, "%")

from scipy.stats import binom

print("Problem 2: The probability of 5 year survival follows a binomial distribution, k is the number of successes, n "
      "is the number of trials and p is the probability.")

print("Problem 3: The likelihood that 400 out of 573 patients survived beyond 5 years is: ",
      binom.pmf(k=400, n=573, p=0.5))
